...
class Variables(button.Button):
    def __init__(self):
        ...
        self.setVariable = ObjectThing("setarVariavel.png", [188, 63], [110, 100], [("L", "femea-normal"), ("N", "femea-normal"), ("S", "macho-normal")],
                                                                                   [("O", "macho-normal"), ("S", "macho-normal"), ("N", "femea-normal")], True, False)
        
        self.useVariable = ObjectThing("variavel.png", [75, 50], [110, 170], [("O", "macho-normal"), ("I", "macho-normal")],[("L", "femea-normal"), ("I", "femea-normal")], True)
