...
class Math(button.Button):
    def __init__(self):
        ...
        self.cte = ObjectThing("constante.png", [38, 25], [110, 30],[("O", "macho-normal"), ("I", "macho-normal")],[("L", "femea-normal"), ("I", "femea-normal")], True, ["1", "2", "3", "4", "5", "6", "7", "8", "9"], "constante")
        self.operacao = ObjectThing("operacao.png", [127, 38], [110, 65], [("O", "macho-normal"), ("I", "femea-normal")],[("L", "femea-normal"), ("I", "macho-normal")], True, ["+", "-", "/", "%", "*"], "operacao")
