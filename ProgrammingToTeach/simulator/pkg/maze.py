...
class Maze:
    ...
    def __init__(self, maxRows, maxColumns, mesh = "square", screen = False, load = False):
        ...
        if mesh == "square":
            ...
            self.board = mapSquare.MapSquare(maxRows*50, maxColumns*50, 50, self.screen, (700,50, load))
        elif mesh == "triangle":
            ...
            self.board = mapTriangle.MapTriangle(maxColumns, maxRows, side, angle, self.screen, (700,50), load)
        else:
            self.board = False
